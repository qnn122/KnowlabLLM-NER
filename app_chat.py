...
def generate_ouput_conversation(model, tokenizer, template_str, conversation_history):
    #conversation_history.append({"role": "user", "content": user_input})
    prompt = render_template(template_str, conversation_history)
    ...
    #        st.chat_input("User Input:", on_submit=on_input_change, key="user_input")
        ...
        if st.session_state.get('model_loaded'):
            if user_input := st.chat_input("User Input:"):
                ...
                with st.chat_message("assistant"):
                    response = st.session_state.generated[-1]
                ...
                print("\n============ generated_full =====================")
                print(st.session_state.generated_full)
                print("\n============ conversation_history =====================")
